...
func (m *Manager) checkPermission(_ context.Context, tenantID, appID, resourceType, resourceID, subjectID, permission string, identity *identity.IdentityContext) (bool, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *Manager) GetPermissions(ctx context.Context, tenantID, appID, resourceType, resourceID, subjectID string, identity *identity.IdentityContext) ([]string, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
