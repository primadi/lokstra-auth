...
type AuthorizationRequest struct {
	...
	Subject *identity.IdentityContext
...
type PermissionChecker interface {
	...
	HasPermission(ctx context.Context, identity *identity.IdentityContext, permission string) (bool, error)

	// HasAnyPermission checks if the subject has any of the specified permissions
	HasAnyPermission(ctx context.Context, identity *identity.IdentityContext, permissions ...string) (bool, error)

	// HasAllPermissions checks if the subject has all of the specified permissions
	HasAllPermissions(ctx context.Context, identity *identity.IdentityContext, permissions ...string) (bool, error)
}

// RoleChecker checks if a subject has specific roles
type RoleChecker interface {
	// HasRole checks if the subject has a specific role
	HasRole(ctx context.Context, identity *identity.IdentityContext, role string) (bool, error)

	// HasAnyRole checks if the subject has any of the specified roles
	HasAnyRole(ctx context.Context, identity *identity.IdentityContext, roles ...string) (bool, error)

	// HasAllRoles checks if the subject has all of the specified roles
	HasAllRoles(ctx context.Context, identity *identity.IdentityContext, roles ...string) (bool, error)
}
