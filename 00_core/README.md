...
import (
    "context"
    "github.com/primadi/lokstra-auth/00_core"
)
...
func main() {
    ...
    // This will use credential layer (01_credential)
...
After `00_core` is complete, other layers will be updated:

1. **01_credential**: Add tenant_id & app_id to all authenticators ✅
2. **02_token**: Include tenant_id & app_id in JWT claims
3. **03_subject**: Resolve subject with tenant context
4. **04_authz**: Scope all authz checks by tenant & app

## See Also

- [Multi-Tenant Architecture](../docs/multi_tenant_architecture.md)
- [Credential Layer](../01_credential/README.md)
- [Token Layer](../02_token/README.md)
