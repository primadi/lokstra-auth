...
type User struct {
	...
	EmailVerifiedAt *time.Time `json:"email_verified_at,omitempty"` // Email verification timestamp
	PhoneNumber     *string    `json:"phone_number,omitempty"`      // Phone number (optional)
	PhoneVerifiedAt *time.Time `json:"phone_verified_at,omitempty"` // Phone verification timestamp
...
type UserApp struct {
	...
	GrantedBy string          `json:"granted_by,omitempty"` // Who granted access
	RevokedAt *time.Time      `json:"revoked_at,omitempty"`
	RevokedBy *string         `json:"revoked_by,omitempty"` // Who revoked access
	Metadata  *map[string]any `json:"metadata,omitempty"`
	CreatedAt time.Time       `json:"created_at"`
	UpdatedAt time.Time       `json:"updated_at"`
}
