...
├── //api/auth/cred/*         - Credential services
├── /api/token/*        - Token services
├── /api/rbac/*      - Subject services
...
curl http://localhost:8082//api/auth/cred/health
...
- `core/01_app_keys` - App API key management
- `core/02_credential_config` - Credential configuration
