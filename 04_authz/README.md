...
**Location**: `04_authz/rbac/evaluator.go`
...
**Location**: `04_authz/abac/evaluator.go`
...
**Location**: `04_authz/acl/manager.go`
...
See the `examples/04_authz/` directory for complete working examples:
...
```bash
go run examples/04_authz/01_rbac_example.go
go run examples/04_authz/02_abac_example.go
go run examples/04_authz/03_acl_example.go
```
