...
type ContextBuilder struct {
	...
	enrichers   []subject.DataEnricher
}

// NewContextBuilder creates a new enriched identity context builder
func NewContextBuilder(baseBuilder subject.IdentityContextBuilder, enrichers ...subject.DataEnricher) *ContextBuilder {
...
func (b *ContextBuilder) AddEnricher(enricher subject.DataEnricher) {
...
func (e *AttributeEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
...
func (e *RoleBasedEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
	if identity.Metadata == nil {
		identity.Metadata = make(map[string]any)
	}
...
func NewProfileEnricher(profileProvider subject.ProfileProvider) *ProfileEnricher {
...
func (e *ProfileEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
...
type CustomEnricher struct {
	enrichFunc func(context.Context, *subject.IdentityContext) error
}

// NewCustomEnricher creates a new custom enricher
func NewCustomEnricher(fn func(context.Context, *subject.IdentityContext) error) *CustomEnricher {
...
func (e *CustomEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
	if e.enrichFunc == nil {
		return nil
	}
...
func (e *SessionEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
	...
	if ipAddress, ok := ctx.Value("ip_address").(string); ok {
		...
		identity.Session.IPAddress = ipAddress
	}
	...
	if userAgent, ok := ctx.Value("user_agent").(string); ok {
		...
		identity.Session.UserAgent = userAgent
	}
...
func NewChainEnricher(enrichers ...subject.DataEnricher) *ChainEnricher {
...
func (e *ChainEnricher) Enrich(ctx context.Context, identity *subject.IdentityContext) error {
...
func (e *ChainEnricher) Add(enricher subject.DataEnricher) {
