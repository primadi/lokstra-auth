...
import (
	"github.com/primadi/lokstra-auth/01_credential/domain/passwordless"
	"github.com/primadi/lokstra/core/request"
)

// PasswordlessAuthService handles passwordless authentication (email/SMS magic link/code)
// @RouterService name="passwordless-auth-service", prefix="/api/cred/passwordless", middlewares=["recovery", "request-logger"]
