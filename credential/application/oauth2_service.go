...
import (
	"github.com/primadi/lokstra-auth/credential/domain/oauth2"
	"github.com/primadi/lokstra/core/request"
)

// OAuth2AuthService handles OAuth2 authentication via HTTP
// @RouterService name="oauth2-auth-service", prefix="${api-auth-prefix:/api/auth}/cred/oauth2", middlewares=["recovery", "request_logger"]
