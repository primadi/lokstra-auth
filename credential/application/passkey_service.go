...
import (
	"github.com/primadi/lokstra-auth/credential/domain/passkey"
	"github.com/primadi/lokstra/core/request"
)

// PasskeyAuthService handles WebAuthn passkey authentication
// @RouterService name="passkey-auth-service", prefix="${api-auth-prefix:/api/auth}/cred/passkey", middlewares=["recovery", "request_logger"]
...
// ListCredentialsRequest request struct for listing credentials
type ListCredentialsRequest struct {
	UserID string `path:"user_id"`
}

// DeleteCredentialRequest request struct for deleting credential
...
func (s *PasskeyAuthService) ListCredentials(ctx *request.Context, req *ListCredentialsRequest) ([]passkey.PasskeyCredential, error) {
...
func (s *PasskeyAuthService) DeleteCredential(ctx *request.Context, req *DeleteCredentialRequest) error {
